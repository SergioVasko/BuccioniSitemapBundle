...
use Buccioni\Bundle\SitemapBundle\Entity\ImageUrl;
    ...
    public function exampleAction()
    {
        ...
        // Other adding url sample this write directly in the current sitemap file
        // if none have opened yet the default ones
        $sitemap->add(new Url('http://example.com'));

        // Updating a url (not implemented yet)
        // $url3 = $sitemap->get('/sample/url/1');
        // $url3->setLastmod(new \DateTime());

        // Removing a url (not implemented yet)
        // $sitemap->remove($url4);
